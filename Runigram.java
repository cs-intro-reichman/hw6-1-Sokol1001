...
public class Runigram {
	...
	public static Color[][] scaled(Color[][] image, int width, int height) {
		...
		double widthScaleFactor = (double) originalWidth / width;
		double heightScaleFactor = (double) originalHeight / height;

		for (int i = 0; i < height; i++) {
			for (int j = 0; j < width; j++) {
				int sourceI = (int) (i * heightScaleFactor);
				int sourceJ = (int) (j * widthScaleFactor);
	...
	public static void morph(Color[][] source, Color[][] target, int n) {
		...
		// Scale target image to source dimensions if they don't match
